...
const ProductCard = (props) => {
    ...
    return (
        ...
        <div className='relative group'>
            ...
            <div className="min-h-80 aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-md bg-gray-200 lg:h-80 cursor-pointer" >
                ...
                <div className="relative top-64 left-9 w-3/4 p-2 text-center rounded-md hidden opacity-90 font-normal group-hover:block bg-white " onClick={()=> setOpen(true)}>
                    Quickview
                </div>
